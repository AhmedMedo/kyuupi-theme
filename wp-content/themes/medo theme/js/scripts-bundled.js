...
function () {
  ...
  function Search() {
    ...
    this.openSearchBtn = (0, _jquery.default)(".js-search-trigger");
    this.closeSearchBtn = (0, _jquery.default)(".search-overlay__close");
    ...
    this.typingTimer;
    this.previousValue;
    this.searchResultsDiv = (0, _jquery.default)("#search-overlay__results");
  } // 2. event
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(medoData.root_url + '/wp-json/medo/v1/search?term=' + this.searchInput.val(), function (results) {
    ...
    key: "DisableScrollBody",
    value: function DisableScrollBody() {
      (0, _jquery.default)("body").addClass("body-no-scroll");
    }
  }, {
    key: "EnableScrollBody",
    value: function EnableScrollBody() {
